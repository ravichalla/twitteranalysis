...
def __init__(self):
  '''      self.file_path = brand
        dire = os.path.dirname(__file__)
        file_path = os.path.join(dire, './iamsambee_tweets.json')
#pandas 
data = np.array([['Name','Avg URLs','Avg fav count','Avg retweet','Avg Mention','Mentioned names top 3','Avg of tweet old','Avg of tweet new','Emojis mostly used'],
                ['Row1',1,2],
                ['Row2',3,4]])
 '''               
...
if __name__ == '__main__':
    ...
    df=df[['Names','AREA','retweet_avg','avg_favorite_all','avg_url_count',
           ...
           ,'most_common_1_gram',
           'most_common_2_gram','most_common_3_gram'
           ]]
